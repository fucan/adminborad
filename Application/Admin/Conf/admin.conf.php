...
return  array(
    ...
    'TMPL_PARSE_STRING' => array(
        '__STATIC__' => dirname(__ROOT__) . '/Public/static',
        '__ADDONS__' => dirname(__ROOT__) . '/Public/' . MODULE_NAME . '/Addons',
        '__IMG__'    => __ROOT__ . '/images',
	...
	'ACTION_WHITELIST' => array(
		'Admin/Index/sr_inter'
	),
    //语言包切换
    'LANG_SWITCH_ON'     =>     true,    //开启语言包功能
    'LANG_AUTO_DETECT'     =>     true, // 自动侦测语言
    'DEFAULT_LANG'         =>     'zh-cn', // 默认语言
    'LANG_LIST'            =>    'zh-cn,en-us,ko-kr', //必须写可允许的语言列表
