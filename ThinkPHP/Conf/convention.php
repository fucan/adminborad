...
return  array(
    ...
    'SESSION_OPTIONS'       =>  array('path'=>RUNTIME_PATH."Session/"), // session 配置数组 支持type name id path expire domain 等参数
    'SESSION_TYPE'          =>  '', // session hander类型 默认无需设置 除非扩展了session hander驱动
    'SESSION_PREFIX'        =>  '', // session 前缀
   // 'VAR_SESSION_ID'      =>  'token',     //sessionID的提交变量
     'VAR_TOKEN_HEADER'      =>  'HTTP_QQ_TOKEN',     //从请求头里面获取sessionid
